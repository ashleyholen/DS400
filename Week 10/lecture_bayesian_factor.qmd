...
```{r}
diet_behavior <- read_xpt("/Users/ashleyholen/Desktop/Bayesian Stats/DS400/Data/nhanes_data/NSF-ALL-SPICE-Alliance DS400 main data-nhanes_data/DR1TOT_J.XPT")
blood_hg <- read_xpt("/Users/ashleyholen/Desktop/Bayesian Stats/DS400/Data/nhanes_data/NSF-ALL-SPICE-Alliance DS400 main data-nhanes_data/2017-2018_Hg-Blood.XPT")
urine_hg <- read_xpt("/Users/ashleyholen/Desktop/Bayesian Stats/DS400/Data/nhanes_data/NSF-ALL-SPICE-Alliance DS400 main data-nhanes_data/2017-2018_Hg-Urine.XPT")
diabetes <- read_xpt("/Users/ashleyholen/Desktop/Bayesian Stats/DS400/Data/nhanes_data/NSF-ALL-SPICE-Alliance DS400 main data-nhanes_data/2017-2018_Diabetes.XPT")
demographics <- read_xpt("/Users/ashleyholen/Desktop/Bayesian Stats/DS400/Data/nhanes_data/NSF-ALL-SPICE-Alliance DS400 main data-nhanes_data/2017-2018_Demographics.XPT")
```
...
-   Find the means of methyl mercury levels for the two populations
...
```{r}
df %>%
  group_by(DRD370B) %>% #has diabetes or not
  summarise(mean_mercury = mean(LBXBGM)) #average mercury levels 
```
