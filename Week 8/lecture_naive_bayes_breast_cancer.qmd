...
```{r}
filtered_data_false_negative <- breast_cancer_data %>%
  filter(confusion_category == "False Negative")
```

```{r}
filtered_data_true_negative <- breast_cancer_data %>%
  filter(confusion_category == "True Negative")
```
